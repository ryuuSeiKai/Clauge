<script lang="ts">
  ...
  async function handleWhatsNew() {
    try {
      ...
      await openUrl('https://Synape.in/changelog.html');
    } catch {
      window.open('https://Synape.in/changelog.html', '_blank');
    }
  }
...
{#if $updateAvailable && !dismissed}
  ...
  <div class="update-notif">
    <div class="un-header">
      ...
      <div class="un-text">
        <span class="un-title">Synapse v{$updateAvailable.version} is available</span>
        <span class="un-desc">
          {#if infoOnly}
