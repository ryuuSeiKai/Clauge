...
<Modal bind:show title="OpenCode Not Found" width="440px">
  <div class="cn-body">
    ...
    <div class="cn-after">
      ...
      After installing, run <code class="cn-code">opencode auth</code> to add an LLM provider key, then restart Synapse so it picks up your updated <code class="cn-code">PATH</code>.
    </div>
