...
<Modal bind:show title="Gemini CLI Not Found" width="440px">
  <div class="cn-body">
    ...
    <div class="cn-after">
      ...
      After installing, run <code class="cn-code">gemini</code> once to sign in with your Google account and trust this workspace, then restart Synapse so it picks up your updated <code class="cn-code">PATH</code>.
    </div>
