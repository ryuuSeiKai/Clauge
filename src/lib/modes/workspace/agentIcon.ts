...
const ANTIGRAVITY =
  '<svg width="11" height="11" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M12 2l2.8 6.2L21 9l-4.5 3.9 1.5 6.1-6-3.6-6 3.6L7.5 13 3 9l6.2-.8L12 2z" fill="#4285F4"/></svg>';

export function agentIcon(provider: string | null | undefined): AgentIcon {
  switch ((provider ?? '').toLowerCase()) {
    case 'antigravity':
      return { svg: ANTIGRAVITY, color: '#4285F4', label: 'Antigravity' };
    case 'claude':
